...
if '.aln' in seq_file:
    ...
    nucs = ['A', 'C', 'G', 'T', '-']
    length_seq_lst = len(SEQUENCES_LIST[0])
    del SEQUENCES_LIST
    for i in nucs:
...
'''classifiers = [RandomForestClassifier(n_estimators=4,max_depth=400,n_jobs=2,min_samples_leaf=4,min_samples_split=4),
RandomForestClassifier(n_estimators=10,max_depth=300,n_jobs=2,min_samples_leaf=4,min_samples_split=4),
RandomForestClassifier(n_estimators=10,max_depth=200,n_jobs=2,min_samples_leaf=4,min_samples_split=4),
RandomForestClassifier(n_estimators=20,max_depth=200,n_jobs=2,min_samples_leaf=4,min_samples_split=4)]'''
#classifiers = [
